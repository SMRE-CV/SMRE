...
def parse_opt():
    ...
    parser.add_argument('--choose', type=str, default='baseline', help='choose from sota|baseline')
    parser.add_argument('--mask', type=str, default='False', help='choose from sota|baseline')
    ...
    parser.add_argument('--vocab_size', type=int, default=16242)#7351
    ...
    parser.add_argument('--msrvtt_caption_train', type=str, default='data/MSR-VTT/train.txt')
    ...
    args.vocab_pkl_path = os.path.join(args.feat_dir,'vocab_%d.pkl')
    ...
    args.msvd_vocab=os.path.join(args.feat_dir,"vocab_refine.pkl")
    args.msrvtt_vocab=os.path.join(args.feat_dir,"vocab_2.pkl")
    args.video_feats_msvd=os.path.join(args.feat_dir,"msvd_feat_res_rext.npy")
    args.video_feats_msrvtt=os.path.join(args.feat_dir,"msrvtt_feat_res_rext.npy")
