...
def evaluate(opt, net, eval_range, prediction_txt_path, reference,mode1="val"):
    ...
    for i, (frames,  video_ids) in tqdm(enumerate(eval_loader)):
        ...
        outputs, _ = net(cnn_feats=frames, captions=None,mode=mode1)
...
if __name__ == '__main__':
    ...
    if not opt.eval_metric:
        ...
        net.load_state_dict(torch.load(opt.best_cider_pth_path,map_location='cpu'))
    else:
